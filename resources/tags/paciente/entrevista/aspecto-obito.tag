        ...
        <div class="columns">
            <div class="column col-3 col-md-12">
                <div class="form-group { errors.metodo_contraceptivo ? 'has-error' : '' }">
                    ...
                    <select name="tfd" class="form-select" disabled="{ dados.somente_visualizar }">
                        <option value=""></option>
            ...
            <div class="column col-3 col-md-12">
                <div class="form-group { errors.gestacao_planejada ? 'has-error' : '' }">
                    ...
                    <select name="gestacao_planejada" class="form-select" disabled="{ dados.somente_visualizar }">
                        <option value=""></option>
                        <option value="S">Sim</option>
                        <option value="N">Não</option>
                    </select>
            ...
            <div class="column col-6 col-md-12">
                <div class="form-group { errors.motivo_nao_prenatal ? 'has-error' : '' }">
                    ...
                    <input type="text" name="motivo_nao_prenatal" maxlength="100" disabled="{ dados.somente_visualizar }" value="{ dados.motivo_nao_prenatal }" class="form-input">
