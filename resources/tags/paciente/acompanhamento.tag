        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="float-right">
                    <button type="submit" if="{ !acompanhamento.codigo }" class="btn btn-primary mr-1">Salvar</button>
                    <button type="submit" if="{ acompanhamento.codigo }" class="btn btn-primary mr-1">Alterar</button>
                ...
                <div class="columns">
                    <div class="column col-12 col-md-12">
                        <div class="form-group { errors.relato ? 'has-error' : '' }">
                            ...
                            <textarea name="relato" rows="5" class="form-input" required>{ acompanhamento.relato }</textarea>
