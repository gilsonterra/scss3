...
use App\Validators\ProfissaoValidator;
...
final class ProfissaoController extends BaseController
{
    ...
    public function __construct(Container $container, ProfissaoRepository $repository, ProfissaoValidator $validator)
    {
